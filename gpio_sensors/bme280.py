...
class GetBme280():
    ...
    def __init__(self):
        ...
        self._setup()
        self.digT, self.digP, self.digH = self._get_calib_param()
    ...
    def readData(self):
        ...
        t_fine = 0.0
        temp, t_fine = self._compensate_T(temp_raw)
        pres = self._compensate_P(pres_raw, t_fine)
        hum = self._compensate_H(hum_raw, t_fine)
